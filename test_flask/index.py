...
@app.route('/display_sql_form')
def display_sql_form():
    users = Userinfo.query.all()
    return render_template('display_sql_form.html', users=users)
...
def submit():
    ...
    contact = Userinfo(id=5, user=name, contact_info=contact_info)
